...
lapply(names(list_sig),function(x){
  ...
  df_meta %>% 
    write_tsv(paste0("../../out/table/revision/modules_AUTOPHAGY/120_Module_score_",x,".tsv"))
  ...
  data2 %>%
    ...
    # scale_color_gradientn(colours = c("blue","gray","red"))
    scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_",x,".pdf"),width = 18,height = 3)
  ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_",x,".png"),width = 18,height = 3)
  ...
  data2 %>%
    ...
    # scale_color_gradientn(colours = c("blue","gray","red"))
    scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_",x,"_2.pdf"),width = 10,height = 3)
  ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_",x,"_2.png"),width = 10,height = 3)
  ...
  data2 %>%
    ...
    # scale_color_gradientn(colours = c("blue","gray","red"))
    scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_split_",x,".pdf"),width = 20,height = 20)
  ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_split_",x,".png"),width = 20,height = 20)
  ...
  # ggsave(paste0("../../out/image/ManualClean/modules_AUTOPHAGY/HVG4000/dist_score_",x,"_2.pdf"),width = 12,height =9)
  ...
  ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_dist_score_ridges_",x,"_2.pdf"),width = 12,height =9)
  ...
  ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_dist_score_ridges_",x,".pdf"),width = 12,height =9)
  ...
  # ggsave(paste0("../../out/image/ManualClean/modules_AUTOPHAGY/HVG4000/violin_score_split_",x,".pdf"),width = 25,height = 9)
  ...
  data2 %>%
    ...
    # scale_fill_manual(values = c("green","yellow","red"))+
    theme(strip.background = element_blank(),axis.text.x = element_text(hjust = 1,angle = 90))
  ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_violin_score_",x,".pdf"),width = 9,height = 9)
})
...
data2 %>%
  ...
  scale_color_gradientn("sig score",
                        ...
                        oob = scales::squish,limits = c(0.1,0.2))
# scale_color_gradientn(colours = c("gray","yellow","red"))
# scale_color_gradientn(colours = viridis::turbo(10))
ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_",x,"_tailored1.pdf"),width = 11,height = 10)
ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_",x,"_tailored1.png"),width = 11,height = 10,bg="white")
...
data2 %>%
  ...
  theme(strip.background = element_blank()) +
  scale_color_gradientn("sig score",
                        colours = viridis::turbo(10),limits = c(0.1,0.2),oob = scales::squish)
ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_",x,"_tailored2.pdf"),width = 11,height = 10)
ggsave(paste0("../../out/image/revision/modules_AUTOPHAGY/120_UMAP_score_",x,"_tailored2.png"),width = 11,height = 10,bg="white")
...
library(UpSetR)
pdf("../../out/image/revision/modules_AUTOPHAGY/120_upset_signatures_shortlist_authophagy.pdf",width = 10,height = 6,onefile = F)
...
df_int %>%
  write_tsv("../../out/table/revision/modules_AUTOPHAGY/120_upset_signatures_shortlist_intersection_autophagy.tsv")
